...
<<<<<<< Updated upstream
	...
	canvas.setAttribute("height", rows * tile_height);
	canvas.setAttribute("width", columns * tile_width);
	...
	// Create objects
	var snake = new Snake();
	var level = new Level(26, 26, 20, 20);
	...
	function init() {
		...
		var up = document.getElementsByClassName("arrow")[0];
		var left = document.getElementsByClassName("arrow")[3];
		var right = document.getElementsByClassName("arrow")[1];
		var down = document.getElementsByClassName("arrow")[2];
		...
		for (var i = 0; i < level.columns; i++) {
			for (var j = 0; j < level.rows; j++) {
				...
				if (tile == 0) {
					...
					context.fillStyle = "#C3F13B";

					context.fillRect(tilex, tiley, level.tilewidth, level.tileheight);
				} else if (tile == 1) {
					// Wall
					// context.fillStyle = "#BCA176";
					context.fillStyle = "#229B07";
					context.fillRect(tilex, tiley, level.tilewidth, level.tileheight);
				} else if (tile == 2) {
					// Apple
